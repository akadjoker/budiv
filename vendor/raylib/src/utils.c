...
void TraceLog(int logType, const char *text, ...)
{
    ...
    switch (logType)
    {
        case LOG_TRACE: __android_log_vprint(ANDROID_LOG_VERBOSE, "DJOKER", text, args); break;
        case LOG_DEBUG: __android_log_vprint(ANDROID_LOG_DEBUG, "DJOKER", text, args); break;
        case LOG_INFO: __android_log_vprint(ANDROID_LOG_INFO, "DJOKER", text, args); break;
        case LOG_WARNING: __android_log_vprint(ANDROID_LOG_WARN, "DJOKER", text, args); break;
        case LOG_ERROR: __android_log_vprint(ANDROID_LOG_ERROR, "DJOKER", text, args); break;
        case LOG_FATAL: __android_log_vprint(ANDROID_LOG_FATAL, "DJOKER", text, args); break;
        default: break;
    }
#else
